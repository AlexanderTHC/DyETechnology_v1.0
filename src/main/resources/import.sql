...
INSERT INTO `dyetechnology_db`.`productos` (`activo`, `cantidad`, `descripcion`, `imagen`, `nombre`, `precio`, `upc`) VALUES (1, '10', 'Sin Descripción, ESTO ES UN PRODUCTO DE PRUEBA', 'https://http2.mlstatic.com/D_NQ_NP_961245-MLA41816931479_052020-O.webp', 'Mouse Gamer Corsair M65 RGB Elite White', '12979', '5673246');
INSERT INTO `dyetechnology_db`.`productos` (`activo`, `cantidad`, `descripcion`, `imagen`, `nombre`, `precio`, `upc`) VALUES (1, '5', 'Sin Descripción, ESTO ES UN PRODUCTO DE PRUEBA', 'https://http2.mlstatic.com/D_NQ_NP_787221-MLA48007684849_102021-O.webp', 'Smart TV Samsung Series 7 LED 4K 50"', '115000', '8946792');
