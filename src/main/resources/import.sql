...
INSERT INTO `dyetechnology_db`.`productos` (`activo`, `cantidad`, `descripcion`, `imagen`, `nombre`, `precio`, `upc`, `id_categoria`) VALUES (1, '10', 'Sin Descripción, ESTO ES UN PRODUCTO DE PRUEBA', 'https://http2.mlstatic.com/D_NQ_NP_961245-MLA41816931479_052020-O.webp', 'Mouse Gamer Corsair M65 RGB Elite White', '12979', '5673246', '3');
INSERT INTO `dyetechnology_db`.`productos` (`activo`, `cantidad`, `descripcion`, `imagen`, `nombre`, `precio`, `upc`, `id_categoria`) VALUES (1, '5', 'Sin Descripción, ESTO ES UN PRODUCTO DE PRUEBA', 'https://http2.mlstatic.com/D_NQ_NP_787221-MLA48007684849_102021-O.webp', 'Smart TV Samsung Series 7 LED 4K 50"', '115000', '8946792', null);
INSERT INTO `dyetechnology_db`.`productos` (`activo`, `cantidad`, `descripcion`, `imagen`, `nombre`, `precio`, `upc`, `id_categoria`) VALUES (1, '15', 'Sin Descripción, ESTO ES UN PRODUCTO DE PRUEBA', 'https://d3ugyf2ht6aenh.cloudfront.net/stores/001/593/734/products/nkb-233-teclado11-897562ccbd6936895316299985198497-640-0.jpg', 'Teclado Noga Gamer NKB-233', '2500', '57853', '2');
INSERT INTO `dyetechnology_db`.`productos` (`activo`, `cantidad`, `descripcion`, `imagen`, `nombre`, `precio`, `upc`, `id_categoria`) VALUES (1, '25', 'Sin Descripción, ESTO ES UN PRODUCTO DE PRUEBA', 'https://http2.mlstatic.com/D_NQ_NP_973536-MLA50480783173_062022-O.webp', 'Parlante Velikka VKK-8810 con Bluetooth', '8000', '871223', null);
